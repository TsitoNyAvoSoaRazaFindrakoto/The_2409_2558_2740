...
if (isset($_GET['id'])) {
  $id = $_GET['id'];
  $data = select_by_first_Row("the_Varietes_de_the", $id)[0];

  $d1 = $data['nom_variete'];
  $d2 = $data['occupation'];
  $d3 = $data['rendement_par_pied'];
}
            ...
            <form role="form" class="text-start" action="<?php if ($id > 0)
              ...
              <input type="hidden" name="id" value="<?php echo $id; ?>">
                <div class="input-group input-group-static my-3">
                  <label>Nom de la variete de the</label>
                  <input type="text" name="nom_variete" class="form-control" value="<?php echo $d1;?>">
                </div>
                <div class="input-group input-group-static mb-3">
                  <label>Occupation</label>
                  <input type="number" name="occupation" class="form-control"  value="<?php echo $d2;?>">

                </div>
                <div class="input-group input-group-dynamic my-3">
                  <label class="form-label">Rendement par pied</label>
                  <input type="number" name="rendement_par_pied" class="form-control" value="<?php echo $d3;?>">
                </div>
