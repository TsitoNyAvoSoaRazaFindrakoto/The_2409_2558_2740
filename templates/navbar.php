...
<nav
  class="navbar navbar-expand-xl  blur border-radius-xl top-0 z-index-fixed shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse pt-3 pb-2 py-xl-0" id="navigation">
      <a href="sign-in.php" class="btn btn-sm  bg-gradient-primary  btn-round mb-0 ms-auto d-xl-none d-block">Login</a>
    ...
    Liens
                ...
                <a href="https://docs.google.com/spreadsheets/d/1EGpE9E9aMz84CqIUv090BTe-JtAlc6jtIcdwz1BE_7I/edit?usp=sharing"
                  class="dropdown-item border-radius-md">
                  <span>To-Do Sheet</span>
                </a>
    ...
    Liens
            ...
            <li class="nav-item dropdown dropdown-hover mx-2">
              ...
              <div class="dropdown-menu dropdown-menu-animation ms-n3 dropdown-md p-3 border-radius-xl mt-0 mt-lg-3"
                ...
                <div class="d-none d-lg-block">
                  ...
                  <a href="inserer-the.php" class="dropdown-item border-radius-md">
                    <span>Ajouter</span>
                  </a>
                  <a href="list-entities.php?table=the_Varietes_de_the" class="dropdown-item border-radius-md">
                    <span>Lister</span>
                  </a>
                  <h6 class="dropdown-header text-dark font-weight-bolder d-flex align-items-center px-1">
                    Gestion de parcelle
                  </h6>
                  <a href="inserer-parcelles.php" class="dropdown-item border-radius-md">
                    <span>Ajouter</span>
                  </a>
                  <a href="list-entities.php?table=the_Parcelles" class="dropdown-item border-radius-md">
                    <span>Lister</span>
                  </a>
                  <h6 class="dropdown-header text-dark font-weight-bolder d-flex align-items-center px-1">
                    Gestion de cueilleurs
                  </h6>
                  <a href="inserer-cueilleur.php" class="dropdown-item border-radius-md">
                    <span>Ajouter</span>
                  </a>
                  <a href="list-entities.php?table=the_Cueilleurs" class="dropdown-item border-radius-md">
                    <span>Lister</span>
                  </a>
                  <h6 class="dropdown-header text-dark font-weight-bolder d-flex align-items-center px-1">
                    Gestion de categories de depense
                  </h6>
                  <a href="inserer-categ-depenses.php" class="dropdown-item border-radius-md">
                    <span>Ajouter</span>
                  </a>
        ...
        <ul class="navbar-nav d-xl-block d-none">
          <li class="nav-item">
            <a href="sign-in.php" class="btn btn-sm  bg-gradient-primary  mb-0 me-1" role="button">Login</a>
          </li>
        </ul>
      </div>
    </div>
